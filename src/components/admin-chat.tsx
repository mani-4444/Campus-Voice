...
import { MessageSquare, ShieldAlert, BadgeInfo, CheckCircle2 } from "lucide-react";
                    ...
                    <div className="rounded-xl bg-card border border-border/60 p-4 hover:bg-muted/10 hover:border-border transition-all duration-200">
                        <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-2">
                                ...
                                {update.type === 'system' && (
                                    <span className="text-[10px] text-muted-foreground/50 border border-border/30 px-1.5 py-0.5 rounded">Automated</span>
                                )}
                            </div>
                            <span className="text-[10px] text-muted-foreground/60 font-mono">{update.time}</span>
                        </div>
