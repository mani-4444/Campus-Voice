...
import { MoreVertical, Shield, ShieldAlert, User, Search } from "lucide-react";

const users = [
    { id: 1, name: "Dr. Sarah Miller", email: "sarah.m@college.edu", role: "Faculty", dept: "Computer Science", status: "Active" },
    { id: 2, name: "Prof. James Chen", email: "j.chen@college.edu", role: "Faculty", dept: "Electrical Eng.", status: "Active" },
    { id: 3, name: "Admin User", email: "admin@college.edu", role: "Admin", dept: "IT Services", status: "Active" },
    { id: 4, name: "Mark Wilson", email: "m.wilson@college.edu", role: "Student", dept: "Mechanical Eng.", status: "Suspended" },
    { id: 5, name: "Emily Davis", email: "e.davis@college.edu", role: "Student", dept: "Biotech", status: "Active" },
];
            ...
            <div className="overflow-x-auto rounded-xl border border-border bg-card">
                <table className="w-full">
                    <thead className="bg-muted/30">
                        <tr>
                            <th className="px-4 py-3 text-left text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">User</th>
                            <th className="px-4 py-3 text-left text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">Role</th>
                            <th className="px-4 py-3 text-left text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">Department</th>
                            ...
                            <tr key={user.id} className="hover:bg-muted/10 transition-colors">
                                ...
                                <td className="px-4 py-3">
                                    <span className={cn(
                                        ...
                                        <span className={cn("h-1.5 w-1.5 rounded-full", user.status === "Active" ? "bg-[var(--success)]" : "bg-destructive")} />
                                        {user.status}
                                    </span>
                                </td>
