    ...
    return (
      <div className="h-full flex flex-col items-center justify-center text-muted-foreground p-8 text-center animate-in fade-in">
        ...
        <p className="text-sm max-w-xs mt-2">
          Select a location from the sidebar to view details, statistics, and
          manage sub-units.
        </p>
      </div>
    );
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            ID: {location.id} • Last audited 2 days ago
          </p>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {location.children.map((child) => (
              <div
                key={child.id}
                className="group p-3 rounded-xl border border-border bg-card/50 hover:bg-card hover:border-primary/30 transition-all cursor-pointer"
              >
