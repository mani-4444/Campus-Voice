...
import { trendData, subjectFeedbackData } from "@/lib/mock/analytics";
import type { DepartmentDataPoint, SentimentDataPoint } from "@/lib/mock/types";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Average days to resolve issues (Last 7 days)
              </p>
            </div>
          </div>
